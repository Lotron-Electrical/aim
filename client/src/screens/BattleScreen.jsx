    ...
    <div className="flex flex-col min-h-screen p-2 sm:p-4">
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-2 sm:gap-4">
        ...
        <div className="max-h-[60vh] overflow-y-auto border border-neon-green-dim bg-bg p-2">
          <h3 className="font-pixel text-[8px] text-neon-green mb-2 sticky top-0 bg-bg pb-1">
            NEURAL LOG
          </h3>
    ...
    <div className={`flex flex-col ${align} min-w-0 flex-1 sm:flex-initial sm:min-w-[120px]`}>
      ...
      <div className="w-full mt-1">
        <div className="flex justify-between">
          ...
          <span className="font-pixel text-[7px] text-neon-green-dim">
            {Math.max(0, hp)}/{maxHp}
          </span>
        </div>
      ...
      <div className="w-full mt-1">
        <div className="flex justify-between">
          ...
          <span className="font-pixel text-[7px] text-cyan-dim">
            {Math.max(0, energy)}/{maxEnergy}
          </span>
        </div>
